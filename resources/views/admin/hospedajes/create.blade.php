...
@section('content')
    ...
    <form action="{{ route('admin.hospedajes.store') }}" method="POST" style="max-width: 800px;">
        @csrf
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 20px;">
            ...
            <div style="grid-column: 1 / -1;">
                ...
                <textarea name="descripcion" rows="4"
                          style="width: 100%; padding: 10px; border: 1px solid #d1d5db; border-radius: 5px;">{{ old('descripcion') }}</textarea>
            </div>
